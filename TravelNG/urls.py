...
urlpatterns = [
                  ...
                  path('deleteRequest/<int:delete_id>', travel.views.travel_request_details,
                       name="deleteTravelRequest"),
                  re_path(r'^Invoice/$', travel.views.travel_invoice_details, name="travelInvoice"),
                  re_path(r'^Invoice/Add/(?P<tr_pk>[0-9]+)/?$', travel.views.travel_invoice_details,
                          name="addTravelInvoice"),
                  re_path(r'^Invoice/Edit/(?P<ti_pk>[0-9]+)/?$', travel.views.travel_invoice_details,
                          name="editTravelInvoice"),
                  path('Invoice/Delete/<int:delete_id>', travel.views.travel_invoice_details,
                       name="deleteTravelInvoice"),
                  ...
                  re_path(r'^Invoice/Refund/Edit/(?P<pk>[0-9]+)/?$', travel.views.travel_invoice_refund,
                          name="editTravelRefund"),
                  re_path(r'^Invoice/pdf/(?P<pk>[0-9]+)/?$', travel.views.create_pdf_document,
                          name="createPdfDocument"),
                  re_path(r'^Request/pdf/(?P<pk>[0-9]+)/?$', travel.views.create_pdf_document, {'pdf': 'tr'},
                          name="createTrPdfDocument"),
