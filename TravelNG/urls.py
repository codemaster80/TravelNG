...
urlpatterns = [
    ...
    re_path(r'^Invoice/Add/$', travel.views.travel_invoice_details, name="addTravelInvoice"),
    re_path(r'^Invoice/Edit/(?P<pk>[0-9]+)/?$', travel.views.travel_invoice_details, name="editTravelInvoice"),
