...
urlpatterns = [
    ...
    path('deleteRequest/<int:delete_id>', travel.views.travel_request_details, name="deleteTravelRequest"),
    ...
    path('Invoice/Delete/<int:delete_id>', travel.views.travel_invoice_details, name="deleteTravelInvoice"),
